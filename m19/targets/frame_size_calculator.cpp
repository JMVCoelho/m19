...
void m19::frame_size_calculator::do_next_node(m19::next_node * const node, int lvl) {
  // EMPTY
}
...
void m19::frame_size_calculator::do_stop_node(m19::stop_node * const node, int lvl) {
  // EMPTY
}
void m19::frame_size_calculator::do_indexing_node(m19::indexing_node * const node, int lvl) {
  // EMPTY
}
void m19::frame_size_calculator::do_identity_node(m19::identity_node * const node, int lvl) {
  // EMPTY
}
void m19::frame_size_calculator::do_body_node(m19::body_node * const node, int lvl) {
  // EMPTY
}
...
void m19::frame_size_calculator::do_function_definition_node(m19::function_definition_node * const node, int lvl) {
  ...
  if (node->body()->initialSection()) {
    node->body()->initialSection()->accept(this, lvl + 2);
  }
  if (node->body()->sections()) {
    node->body()->sections()->accept(this, lvl + 2);
  }
  if (node->body()->finalSection()) {
    node->body()->finalSection()->accept(this, lvl + 2);
  }
}
...
void m19::frame_size_calculator::do_conditional_section_node(m19::conditional_section_node * const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}
